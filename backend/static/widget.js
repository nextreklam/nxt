...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // --- CONFIGURATION ---
  // Ersetze diese URL mit deiner echten Render-Subdomain (z.B. https://onrender.com)
  const BACKEND_URL = "https://nxt-4llp.onrender.com";
  const FRONTEND_URL = "https://nextreklam.com.tr"; // Deine Domain auf Güzel
  ...
  // KORRIGIERT: Nutzt die absolute FRONTEND_URL für den Redirect, wenn der Nutzer auf der Galerie-Seite klickt
  ...
  if (chatToggle && chatWindow && chatClose) {
    ...
    // KORRIGIERT: Der Syntaxfehler `.style.style.display` wurde auf `.style.display` repariert!
    ...
    async function sendMessage() {
      ...
      try {
        // KORRIGIERT: Ruft nun die CORS-freigegebene BACKEND_URL auf Render auf statt Güzel
